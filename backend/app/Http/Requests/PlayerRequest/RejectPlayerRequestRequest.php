...
class RejectPlayerRequestRequest extends FormRequest
{
    public function authorize(): bool
    {
        ...
        if ($user->role->name !== 'captain') {
            throw new AuthorizationException('Only captains and admins can reject player requests.');
        }
        ...
        if (! $isCaptainOfTeam) {
            throw new AuthorizationException('You can only reject requests for your own team.');
        }
